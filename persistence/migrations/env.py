...
from services.course_service.app.core.config import settings
...
# Do not store database secrets in alembic.ini.
# Use DATABASE_URL loaded from the project's .env instead.
